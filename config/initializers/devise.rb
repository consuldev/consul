...
Devise.setup do |config|
  ...
  config.omniauth :irma,
                  strategy_class: OmniAuth::Strategies::Irma,
                  irma_server: Rails.application.secrets.irma_oauth2_site,
                  requestor_token: Rails.application.secrets.irma_oauth2_key
